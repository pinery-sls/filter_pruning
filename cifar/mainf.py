...
def save_checkpoint(state, is_best, filepath):
    torch.save(state, os.path.join(filepath, 'checkpoint_densenet10011.pth'))
    if is_best:
        shutil.copyfile(os.path.join(filepath, 'checkpoint_densenet10011.pth'), os.path.join(filepath, 'model_bestf.pth'))
...
# torch.save(model, 'densenet40.pth')